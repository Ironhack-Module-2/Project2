module.exports.generateEmail = (userId) => {
    ...
    <style type="text/css">
      @media only screen and (min-width:480px) {
        .mj-column-per-66-66666666666666 { width:66.66666666666666% !important; max-width: 66.66666666666666%; }
  ...
  .mj-column-per-100 { width:100% !important; max-width: 100%; }
        ...
        >
          <tbody>
            <tr>
              ...
              >
                <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:middle;width:399.99999999999994px;" ><![endif]-->
      <div
         class="mj-column-per-66-66666666666666 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;"
      >
      <table
      ...
      ><p><span style="color: rgb(106, 138, 162);"><span style="font-weight: bold;"><span style="font-size: 16px;">Thanks for joining Example</span></span>
              ...
              <tr>
                <td
                   align="justify" style="font-size:0px;padding:10px 25px;padding-top:0;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;"
                >
      <div
      ...
      ><p><span style="color: rgb(57, 63, 76);">Click on the following button to activate your account</span></p></div>
              ...
              <tr>
                <td
                   align="center" vertical-align="middle" style="font-size:0px;padding:15px 30px;padding-top:10;padding-right:25px;padding-bottom:10px;padding-left:25px;word-break:break-word;"
                >
      <table
